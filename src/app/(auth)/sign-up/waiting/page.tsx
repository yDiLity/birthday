import { SignupWaiting } from "@/components/signup-waiting";
import { ThemeToggle } from "@/components/theme-toggle";
import { MailCheck } from "lucide-react";
import Link from "next/link";

interface SignUpWaitingProps {
  searchParams: Promise<{ email?: string }>;
}

export default async function SignUpWaitingPage({
  searchParams,
}: SignUpWaitingProps) {
